...
/**
 * Kafka publisher used by {@link com.example.kafkametrics.services.processor.IEventProcessor} implementations.
 * Publishes JSON objects via a dedicated {@link KafkaTemplate} backed by Jackson's {@code JsonSerializer}.
 */
@Service
public class KafkaProducerService {
    ...
    /**
     * Publishes a JSON object to the specified Kafka topic.
     *
